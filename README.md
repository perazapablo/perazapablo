...
📍 Yucatán, México · 💼 Full-stack dev at PC Oriente Desarrollos · 🎓 Digital Business & Virtual Environments student
...
Tooling that makes AI coding agents remember what they did and stay inside the lines.

|  | Project | Description |
|---|---|---|
| 🧠 | [**building_mem**](https://github.com/perazapablo/building_mem) | Persistent memory for AI agents. Rust + SQLite/FTS5, MCP over stdio, Tauri desktop viewer. |
| 🛡️ | [**agent-rules**](https://github.com/perazapablo/agent-rules) | Guardrails that enforce instead of suggest. Hooks for Claude Code, opencode and omp. |

## What I Ship at Work

Admin systems people open every morning, and the APIs behind them.
